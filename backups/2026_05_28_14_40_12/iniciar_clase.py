...
def realizar_backup():
    ...
    try:
        ...
        print(f"[*] Backup automÃ¡tico creado exitosamente en: {backup_dir}")
    ...
    def do_POST(self):
        ...
        if parsed_path.path == '/api/puntos':
            ...
            try:
                ...
                # Caso estÃ¡ndar (Sumar Puntos / Nota)
...
def start_server():
    ...
    with socketserver.TCPServer((HOST, PORT), CustomHandler) as httpd:
        print("[*] Servidor en ejecuciÃ³n con API PvP. Presiona Ctrl+C en esta terminal para detenerlo.")
        httpd.serve_forever()
