...
const app = {
    ...
    // -------------------------------------------------------------
    // SISTEMA DE PUNTUACIÓN Y LEADERBOARD (API Python)
    // -------------------------------------------------------------
    ...
    renderOvaContent() {
        ...
        let html = `
            ...
            <section class="ova-section">
                ...
                <button class="btn-mision-check" onclick="app.updateProgress(15); alert('✅ Misión en Cuaderno Completada!');">✅ Misión en Cuaderno Completada</button>
            </section>
            ...
            <section class="ova-section">
                <h3>➕ Criptografía Espacial (Crucigrama)</h3>
            ...
            <section class="ova-section">
                ...
                <button class="btn-mision-check" onclick="app.updateProgress(15); alert('✅ Misión en Cuaderno 2 Completada!');">✅ Misión en Cuaderno Completada</button>
            </section>
    ...
    touchStart(e) {
        ...
        // Guardamos posición original por si soltamos en la nada
    ...
    touchEnd(e) {
        ...
        // Ocultar momentáneamente para detectar qué hay debajo
        ...
        // Verificar si caímos en un cajón válido
        ...
        // Si no es válido o está lleno, devolvemos a su padre original
    ...
    async procesarResultadoHuevo(efecto, porcentaje) {
        ...
        if (efecto === 'BUFF') {
            ...
            resDiv.innerHTML = �Bendici�n Acad�mica! <br> + + porcentaje + % puntos (+ + extra +  pts);
            ...
            resDiv.innerHTML = �Robo Activado! <br> Robar�s el  + porcentaje + % a un compa�ero.;
    ...
    async iniciarPvP(porcentaje) {
        ...
        try {
            ...
            lista.innerHTML = 'Error de conexi�n.';
        }
    },
    ...
    async finalizarOva() {
        ...
        if(nota < 1.0) nota = 1.0; // Nota m�nima
    ...
    verificarDragAndDrop() {
        ...
        if(correctos) {
            alert('¡Impecable! Todo está ordenado correctamente.');
            app.updateProgress(10);
            app.sumarPuntos(20); setTimeout(() => app.lanzarHuevos(), 500);
        } else {
            alert('Aún hay piezas desordenadas. ¡Inténtalo de nuevo!');
        }
    },
    ...
    renderCrucigrama(crucigramaData) {
        ...
        for(let r=1; r<=maxY; r++) {
            ...
            for(let c=1; c<=maxX; c++) {
                if(grid[r][c]) {
                    tableHtml += `<td><input type="text" maxlength="1" class="crucigrama-cell" /></td>`;
                } else {
