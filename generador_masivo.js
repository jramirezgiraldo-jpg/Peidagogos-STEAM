...
const semanaObjetivo = process.argv[2] || "1";
console.log("Generando guías para la Semana:", semanaObjetivo);
...
const materias = allMaterias.filter(m => m.semana === semanaObjetivo);
if (materias.length === 0) {
    console.log("No hay materias definidas para esta semana.");
    process.exit(0);
}
